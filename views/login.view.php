...
<div class="relative h-[100vh] flex flex-col gap-10 items-center bg-secondary text-white py-3">

    <a href="/" class="absolute group md:top-10 top-5 md:left-10 left-5 flex gap-1">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 group-hover:-translate-x-2 duration-300">
    ...
    <div class="h-full flex flex-col justify-center items-center gap-5">
        <div class="flex flex-col justify-center items-center gap-3">
            <svg width="171.80394696370004" height="121.565625" viewBox="0 0 100 70.75834237131073" class="size-16 bg-[#595959] p-1 rounded-md">
        ...
        <form action="" method="post" class="md:w-96 w-80 p-5 flex flex-col justify-center items-center gap-5 bg-third rounded-lg">
            ...
            <div class="w-full flex flex-col gap-3">
                ...
                <?php if (isset($_GET['error'])) : ?>
                    <span class="text-red-500 bg-white rounded-md px-2 py-1">Incorrect Username or Password</span>
                <?php endif ?>
                <div class="flex justify-center">
                    <input type="submit" value="Login" class="cursor-pointer bg-primary w-1/2 py-1 rounded-md">
                </div>
            </div>
        </form>
    </div>

    <div class="mt-auto flex flex-col justify-center gap-5 items-center">
