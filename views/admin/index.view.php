                ...
                <form action="/project/create" method="post" id="createForm" enctype="multipart/form-data" class="p-5 flex flex-col justify-center items-center gap-5">
                    ...
                    <div class="w-full flex flex-col gap-3">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="file" accept="image/jpeg, image/png, image/jpg" name="photo" id="photo" class="border border-fifth rounded-md px-2 py-1 outline-none focus:border-blue-600" required>
                        </div>
            ...
            <div class="relative md:w-96 w-80 bg-white border rounded-md shadow-md">
                ...
                <form action="/project/update" method="post" id="updateForm" enctype="multipart/form-data" class="p-5 flex flex-col justify-center items-center gap-5">
                    ...
                    <div class="w-full flex flex-col gap-3">
                        ...
                        <div class="flex flex-col gap-1">
                            <label for="update-photo">Photo</label>
                            <input type="file" accept="image/jpeg, image/png, image/jpg" name="update_photo" id="update-photo" class="border border-fifth rounded-md px-2 py-1 outline-none focus:border-blue-600">
                        </div>
                        <div class="flex flex-col gap-1">
                            <input type="text" value="" name="photo" id="photo" class="border hidden border-fifth rounded-md px-2 py-1 outline-none focus:border-blue-600" required>
                        </div>
                        <div class="flex justify-center">
        ...
        <div class="h-[80vh] overflow-y-scroll border rounded-md 2xl:mx-16 md:mx-5 mx-1">
            <table id="table" class="table-auto w-full text-nowrap">
                ...
                <tr class="sticky top-0 z-10 border bg-third text-white">
                    ...
                    <td class="w-56 text-center hidden border border-gray-300 p-1">Photo</td>
                ...
                <tbody class="">
                    <?php foreach ($projects as $project) : ?>
                        <tr class="project-table-row">
                            ...
                            <td class="project-photo hidden border border-gray-300 p-2"><?= $project['photo'] ?></td>
                            ...
                            <td class="border border-gray-300 p-2 text-center">
                                <div class="flex justify-evenly md:gap-2 gap-5">
                                    ...
                                    <a href="/project/delete?id=<?= $project['id'] ?>&name=<?= $project['photo'] ?>" class="text-red-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 pointer-events-none">
